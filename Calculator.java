...
public class Calculator extends JFrame implements ActionListener {  
    ...
    JPanel panel,panel1,panel2,panel3,panel4,panel5,topPanel,resultPanel;//topPanel画板放文本框  
    //设置单选框，以方便选择男女
    ...
    *********************/  
    ...
    private void init() {   	
        ...
        waistText.setFont(new Font("微软雅黑", Font.PLAIN, 14));
...
//   }
   ...
   private String PutOn(){
	   ...
	   return(df.format(bottom)+"~"+df.format(top)+"卡路里/天");
   }
   /*增重所需的能量*/
